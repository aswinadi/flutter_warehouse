...
_$PaymentTransactionImpl _$$PaymentTransactionImplFromJson(
    ...
    _$PaymentTransactionImpl(
      ...
      supplierBankName: json['supplier_bank_name'] as String?,
      supplierBankAccount: json['supplier_bank_account'] as String?,
      supplierBankAccountName: json['supplier_bank_account_name'] as String?,
...
Map<String, dynamic> _$$PaymentTransactionImplToJson(
    ...
    <String, dynamic>{
      ...
      'supplier_bank_name': instance.supplierBankName,
      'supplier_bank_account': instance.supplierBankAccount,
      'supplier_bank_account_name': instance.supplierBankAccountName,
