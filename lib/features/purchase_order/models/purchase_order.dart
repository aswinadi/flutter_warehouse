...
class PurchaseOrder with _$PurchaseOrder {
  const factory PurchaseOrder({
    ...
    @JsonKey(name: 'dp_paid_amount', fromJson: doubleOrNullFromJson) double? dpPaidAmount,
    @JsonKey(name: 'remaining_dp_amount', fromJson: doubleOrNullFromJson) double? remainingDpAmount,
