...
_$PurchaseOrderImpl _$$PurchaseOrderImplFromJson(Map<String, dynamic> json) =>
    _$PurchaseOrderImpl(
      ...
      dpPaidAmount: doubleOrNullFromJson(json['dp_paid_amount']),
      remainingDpAmount: doubleOrNullFromJson(json['remaining_dp_amount']),
...
Map<String, dynamic> _$$PurchaseOrderImplToJson(_$PurchaseOrderImpl instance) =>
    <String, dynamic>{
      ...
      'dp_paid_amount': instance.dpPaidAmount,
      'remaining_dp_amount': instance.remainingDpAmount,
