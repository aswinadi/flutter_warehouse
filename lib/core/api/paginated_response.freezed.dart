...
abstract class $PaginatedResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call(
      {bool success, List<T> data, PaginationMeta? meta, String? message});
...
class _$PaginatedResponseImpl<T> implements _PaginatedResponse<T> {
  ...
  @override
  String toString() {
    return 'PaginatedResponse<$T>(success: $success, data: $data, meta: $meta, message: $message)';
  }
...
abstract class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const factory _PaginatedResponse(
      ...
      required final List<T> data,
      final PaginationMeta? meta,
      final String? message}) = _$PaginatedResponseImpl<T>;
