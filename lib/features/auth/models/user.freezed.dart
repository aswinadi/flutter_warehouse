...
mixin _$User {
  ...
  List<String> get approvalTypes => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      companyId: freezed == companyId
          ...
          : companyId // ignore: cast_nullable_to_non_nullable
              as int?,
      approvalTypes: null == approvalTypes
          ? _value.approvalTypes
          : approvalTypes // ignore: cast_nullable_to_non_nullable
              as List<String>,
      roles: null == roles
          ? _value.roles
...
class _$UserImpl extends _User {
  ...
  @override
  @JsonKey(name: 'approval_types')
  List<String> get approvalTypes {
    if (_approvalTypes is EqualUnmodifiableListView) return _approvalTypes;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_approvalTypes);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._approvalTypes, _approvalTypes) &&
